...
function App() {
  ...
  const contractAddress = "0xe55A3838174023e7b18a8d3B72D95C3b5e3e38d9"; // Paste the address recieved from Remix IDE here
        ...
        : (
          <div>
            ...
            <div style={{ margin: '15px 0' }}>
              ...
              />
              <button onClick={updateNameOnChain}>Update Name</button>
            </div>
            ...
            <button onClick={fetchUserCount}>Show Registered User Count</button>
                {userCount !== null && (
